//-----------------------------------------------------------------------
// <copyright file="JsonAwesomeAssertionsExtensions.cs" company="P.O.S Informatique">
...
namespace AwesomeAssertions
{
    ...
    /// </summary>
    public static class JsonAwesomeAssertionsExtensions
    {
        /// <summary>
        ...
        /// the default <see cref="IAwesomeAssertionsJsonConfiguration.JsonSerializerOptions"/> of the <see cref="AwesomeAssertionsJson.Configuration"/>
        /// will be used.</param>
        ...
        /// <param name="assertions"><see cref="ObjectAssertions"/> which contains the object subject to check.</param>
        /// <param name="expectedJson">The object which represents the raw JSON object expected.</param>
        /// <param name="configureOptions">Allows to change the default <see cref="IAwesomeAssertionsJsonConfiguration.JsonSerializerOptions"/>
        /// of the <see cref="AwesomeAssertionsJson.Configuration"/> used to assert the serialization.</param>
        ...
        {
            var optionsCopy = new JsonSerializerOptions(AwesomeAssertionsJson.Configuration.JsonSerializerOptions);
        ...
        /// <param name="expectedObject">Expected object deserialized expected.</param>
        /// <param name="configureOptions">Allows to change the default <see cref="IAwesomeAssertionsJsonConfiguration.JsonSerializerOptions"/>
        /// of the <see cref="AwesomeAssertionsJson.Configuration"/> used to assert the deserialization.</param>
                ...
                opt.Using<object>(ctx =>
                   {
                       ...
                       {
                           var path = ReflectionHelper.GetJsonPath(deserializedObject!, ctx.SelectedNode.Subject.PathAndName);
...
#pragma warning disable CS0618 // Type or member is obsolete
                   .When(member => member.Type == typeof(object));      // We use the "Type" property for now, because the CompileTimeType give the wrong value.
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private static JsonSerializerOptions GetSerializerOptions(JsonSerializerOptions? options)
        {
            if (options is null)
            {
                return AwesomeAssertionsJson.Configuration.JsonSerializerOptions;
            }
