# PosInformatique.AwesomeAssertions.Json

PosInformatique.AwesomeAssertions.Json is a library to assert JSON serialization using the [Awesome Assertions](https://awesomeassertions.org/) library style coding.
...
[![Nuget](https://img.shields.io/nuget/v/PosInformatique.AwesomeAssertions.Json)](https://www.nuget.org/packages/PosInformatique.AwesomeAssertions.Json/)
official website.

To download and install the library to your Visual Studio unit test projects use the following NuGet command line:

```powershell
Install-Package PosInformatique.AwesomeAssertions.Json
```
...
![Ugly exception](https://raw.githubusercontent.com/PosInformatique/PosInformatique.AwesomeAssertions.Json/main/docs/UglyExceptionExample.png)
...
![Pretty exception](https://raw.githubusercontent.com/PosInformatique/PosInformatique.AwesomeAssertions.Json/main/docs/PrettyExceptionSample.png)
...
This is the assertion to write using the [PosInformatique.AwesomeAssertions.Json library](https://www.nuget.org/packages/PosInformatique.AwesomeAssertions.Json/):
...
of `AwesomeAssertionsJson.Configuration.JsonSerializerOptions`.
...
It is possible to changes the global `AwesomeAssertionsJson.Configuration.JsonSerializerOptions`
...
`AwesomeAssertionsJson.Configuration.JsonSerializerOptions` instance during the call
...
- The [PosInformatique.AwesomeAssertions.Json](https://www.nuget.org/packages/PosInformatique.AwesomeAssertions.Json/) library
