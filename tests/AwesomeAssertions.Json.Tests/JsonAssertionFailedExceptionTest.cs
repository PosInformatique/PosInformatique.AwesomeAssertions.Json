...
namespace PosInformatique.AwesomeAssertions.Json.Tests
{
    ...
    public class JsonAssertionFailedExceptionTest
    {
        ...
        public void Constructor()
        {
            ...
            exception.Message.Should().Be("Exception of type 'PosInformatique.AwesomeAssertions.Json.JsonAssertionFailedException' was thrown.");
